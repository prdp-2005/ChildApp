                ...
                <div className='hidden md:block '>
                    <div className=' mt-16 flex px-10  md:flex-nowrap flex-row  items-start justify-center'>
                        ...
                        <div className='flex-col w-[50%] gap-5 justify-center items-center '>
                            {data.map((item, index) =>
                                <div key={item.id} onClick={() => handleTabClick(index)} className='flex flex-col gap-2 cursor-pointer justify-center bg-primary-alpha-10 shadow-sm items-start rounded-lg hover:bg-teal-100 hover:shadow-md p-5 w-full flex-wrap'>
